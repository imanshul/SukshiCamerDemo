...
public class FaceDect {
    ...
    public static OnFaceDetectedListener OnFaceDetectedListener;
    ...
    /*
     *   When detected a face
     * */
    public interface OnFaceDetectedListener {
        void onFaceDetected(boolean isFaceDetected);
    }
...
//        this.mOnFrontalFaceDetectedListener = (OnFrontalFaceDetectedListener) context;
        ...
        this.OnFaceDetectedListener = (OnFaceDetectedListener) context;
    }
